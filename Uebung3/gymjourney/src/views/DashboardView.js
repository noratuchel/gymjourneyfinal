          ...
          <>
            ...
            <div className="container-fluid padding">
              <div className="welcome">
                ...
                <div className="col-12">
                  <p className="lead">
                    Willkommen bei deiner Gym Journey! Steig ein und zeig uns
                    wie du begonnen hast, wie du dich entwickelst und was deine
                    Ziele sind. Wir helfen dir daraufhin zu arbeiten.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="container-fluid padding">
              <div className="row text-center padding">
                <div className="col-xs-12 col-sm-6 col-md-4">
                  ...
                  <h3>Training</h3>
                  <p>
                    Ob im Fitnessstudio oder zu Hause, trainiere so wie du dich
                    am wohlsten fühlst und teile deine Erfahrungen mit anderen.
                  </p>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4">
                  ...
                  <p>
                    ...
                    Muskelaufbau oder Gewichtsreduktion - für jeden ist was
                    dabei.
                  </p>
                </div>
                <div className="col-sm-12 col-md-4">
                  ...
                  <h3>Yoga</h3>
                  <p>
                    Du willst einfach nur entspannen? Dann ist unsere
                    Yoga-Section perfekt für dich und vielleicht findest du die
                    ein oder andere neue Figur.{" "}
                  </p>
                </div>
              </div>
              <hr className="my-4" />
